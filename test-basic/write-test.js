...
describe('optic write function', function () {
    ...
    // after(function(done) {
    //     let usedUris = ['/test/bindFromParam/data1.json', '/test/bindFromParam/data2.json', '/test/bindFromParam/data3.json', '/test/bindFromParam/data5.json'];
    //     dbWriter.documents.remove(usedUris)
    //         .result(function () {
    //             done();
    //         })
    ...
    it('test with all identifiers and query rows', function (done) {
        const docsDescriptor = [{
            ...
            permissions: [{'role-name': 'app-user', capabilities: ['read', 'update']}, {'role-name': 'rest-reader', capabilities: ['read', 'update']}, {'role-name': 'rest-writer', capabilities: ['read', 'update']}],
    ...
    it('test fromParam adding 1 json file', function (done) {
        ...
        const rows = [{id: 1, doc: {"desc": "doc1"}, uri: '/test/bindFromParam/data1.json', collections: ['newCol', 'test']}];
        const outputCols = [{"column": "id", "type": "integer", "nullable": false}, {
            "column": "doc",
            "type": "none",
            "nullable": false
        }, {"column": "uri", "type": "string", "nullable": false},  {"column":"collections", "type":"none",    "nullable":true}];

        const planBuilderTemplate = op.fromParam(bindingParam, null, outputCols).write({uri: op.col('uri'), collections: op.col('collections'), doc: op.col('doc')});
    ...
    it('test fromParam adding 2 json files', function (done) {
        ...
        const rows = [{id: 2, doc: {"desc": "doc2"}, uri: '/test/bindFromParam/data2.json', collections: ['newCol', 'test']},
            {id: 3, doc: {"desc": "doc3"}, uri: '/test/bindFromParam/data3.json', collections: ['newCol', "doc3"], quality: 3}];
        const outputCols = [{"column": "id", "type": "integer", "nullable": false}, {
            "column": "doc",
            "type": "none",
            "nullable": false
        ...
        const planBuilderTemplate = op.fromParam(bindingParam, null, outputCols).write({uri: op.col('uri'), collections: op.col('collections'), doc: op.col('doc'), quality: op.col('quality')});
        const bindParam = {[bindingParam]: rows};
        try {
            db.rows.execute(planBuilderTemplate, null, bindParam);
            setTimeout(() => {
    ...
    it('test fromParam changing 1 json file', function (done) {
        ...
        const rows = [{id: 1, doc: {"desc": "test"}, uri: '/test/bindFromParam/data1.json', collections: ['updated', 'test'], quality: 6}];
        const outputCols = [{"column": "id", "type": "integer", "nullable": false}, {
            "column": "doc",
            "type": "none",
            "nullable": false
    ...
    it('test fromParam changing 2 json files', function (done) {
        ...
        const rows = [{id: 2, doc: {"desc": "changed2"}, uri: '/test/bindFromParam/data2.json', collections: ['updated', 'test'], permissions: [{'roleName': 'rest-writer', capability: 'update'},{'roleName': 'rest-writer', capability: 'read'}]},
            {id: 3, doc: {"desc": "doc3"}, uri: '/test/bindFromParam/data3.json', collections: ['newCol', "updated"], quality: 3}];
        const outputCols = [{"column": "id", "type": "integer", "nullable": false}, {
            "column": "doc",
            "type": "none",
            "nullable": false
        ...
        const planBuilderTemplate = op.fromParam(bindingParam, null, outputCols).write({uri: op.col('uri'), collections: op.col('collections'), doc: op.col('doc'), quality: op.col('quality'), permissions: op.col('permissions')});
        const bindParam = {[bindingParam]: rows};
        try {
            db.rows.execute(planBuilderTemplate, null, bindParam);
            setTimeout(() => {
    ...
    it('test fromParam with query and other identifiers name', function (done) {
        ...
        const rows = [{id: 1, myDoc: {"desc": "doc5"}, myUri: '/test/bindFromParam/data5.json', collect: ['fromParam']}];
        const outputCols = [{"column": "id", "type": "integer", "nullable": false}, {
            "column": "myDoc",
            "type": "none",
            "nullable": false
        ...
        const planBuilderTemplate = op.fromParam(bindingParam, null, outputCols).write({doc: op.col('myDoc'), uri: op.col('myUri'), collections: op.col('collect')});
        const bindParam = {[bindingParam]: rows};
        try {
    ...
    it('test write with xml attachments', function (done) {
        ...
        const rows = [{rowId: 1, doc: 'doc1.xml', uri: '/test/fromParam/doc1.xml'}, {rowId: 2, doc: 'doc2.xml', uri: '/test/fromParam/doc2.xml'}];
    ...
    it('test write with txt attachments', function (done) {
        ...
        const rows = [{rowId: 1, doc: 'doc1.txt', uri: '/test/fromParam/doc1.txt'}, {rowId: 2, doc: 'doc2.txt', uri: '/test/fromParam/doc2.txt'}];
